...
RSpec.describe FreshdeskRails::ViewHelper do
  ...
  describe "#update_freshdesk_locale" do
    context "without options" do
      subject { update_freshdesk_locale }
      it { should eq "<script>\n//<![CDATA[\nwindow.FreshdeskRails.locale=\"en\";\n//]]>\n</script>" }
    end

    context "with locale zh-TW" do
      subject { update_freshdesk_locale(:locale => 'zh-TW') }
      it { should eq "<script>\n//<![CDATA[\nwindow.FreshdeskRails.locale=\"zh-TW\";\n//]]>\n</script>" }
    end

    context "with options" do
      subject { update_freshdesk_locale(:locale => 'zh-TW', "buttonText": "Help", "submitThanks": "Thanks for your feedback", "formTitle": "Ask Something...") }
      it { should eq "<script>\n//<![CDATA[\nwindow.FreshdeskRails.locale=\"zh-TW\";window.FreshdeskRails.languages={\"submitThanks\":\"Thanks for your feedback\",\"formTitle\":\"Ask Something...\",\"buttonText\":\"Help\"};\n//]]>\n</script>" }
    end
  end
end
